...
<img src="/react/virtual_1.png" style="margin: 20px 0;width: 80%"/>
...
`babel`在转化`jsx`的时候默认是使用`React.createElement `方法的，如果我们需要实现自己的`createElement `方法，我们可以在要转换的`jsx`文件的头部使用注释指定,这样的需要在每个文件中指定.
...
//@jsx tiny.createElement
tiny.createElement("div", null, "hello world");
```

还有一种方式,是在`babel`转换`jsx`的插件中指定选项：
...
[
	...
	"@babel/preset-react",
  {
		pragma: "TinyReact.createReactElement",
...
<img src="/react/virtual_2.png" width="50%"/>
...
<img src="/react/virtual_3.png" width="50%"/>
...
<img src="/react/virtual_8.png" width="80%" style="margin-bottom: 30px"/>
